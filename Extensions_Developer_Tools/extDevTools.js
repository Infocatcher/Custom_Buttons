...
var images = {
	...
	get browserToolbox() {
		return cmds.platformVersion < 97
			? "chrome://devtools/skin/images/command-pick.svg"
			// https://bugzilla.mozilla.org/show_bug.cgi?id=1531311
			: "chrome://devtools/content/shared/images/command-pick.svg";
	},

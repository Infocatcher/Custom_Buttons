...
##### [Add New Buttons After This Button](Custom_Buttons/blob/master/Add_New_Buttons_After_This_Button)
New custom buttons will automatically placed after this button (button are disabled by default, click to enable)

##### [Attributes Inspector](Custom_Buttons/blob/master/Attributes_Inspector)
...
##### [Bookmarks Folder](Custom_Buttons/blob/master/Bookmarks_Folder)
Show contents of any bookmarks folder in drop-down menu

##### [Custom Buttons: Disable Initialization](Custom_Buttons/blob/master/CB_Disable_Initialization)
Add “Enabled” checkbox to custom button's context menu (for test purposes)

##### [Custom Buttons Editor: Toggle on Top](Custom_Buttons/blob/master/CB_Editor_Toggle_on_Top)
Add “On top” button to built-in custom button's editor (doesn't work on some platforms!)

##### [Check for Addons Updates](Custom_Buttons/blob/master/Check_for_Addons_Updates)
...
##### [Cookies Permissions](Custom_Buttons/blob/master/Cookies_Permissions)
...
##### [Detach Tab](Custom_Buttons/blob/master/Detach_Tab)
...
##### [Edit Custom Button in Tab](Custom_Buttons/blob/master/Edit_Custom_Button_in_Tab)
Add “Edit button in tab…” to custom button's context menu

##### [Extensions Developer Tools](Custom_Buttons/blob/master/Extensions_Developer_Tools)
...
##### [Session Bookmarks](Custom_Buttons/blob/master/Session_Bookmarks)
...
##### [Title Bar](Custom_Buttons/blob/master/Title_Bar)
Show window title (if original title was hidden by some reasons)

##### [Toggle Flash](Custom_Buttons/blob/master/Toggle_Flash)
Toggle Shockwave Flash plugin

##### [Undo Close Tabs](Custom_Buttons/blob/master/Undo_Close_Tabs)
